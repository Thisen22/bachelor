...
# OLS-model (uden fixed effects)
ols_model <- plm(relative_point ~ relative_revenue + relative_wage, data = data_filtered, model = "pooling")

# Fixed effects-model
fe_model <- plm(relative_point ~ relative_revenue + relative_wage, data = data_filtered, model = "within")
